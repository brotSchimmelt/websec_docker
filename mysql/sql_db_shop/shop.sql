...
(1, 'WebSec Mug', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 599, '/assets/img/prod/prod_mug.jpg'),
...
(3, 'WebSec Bag', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 999, '/assets/img/prod/prod_bag.jpg'),
(4, 'WebSec Pillow', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 2399, '/assets/img/prod/prod_pillow.jpg'),
(5, 'WebSec T-Shirt', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 1499, '/assets/img/prod/prod_tshirt2.jpg'),
...
(7, 'WebSec Sweater', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 3099, '/assets/img/prod/prod_sweater.jpg'),
(8, 'WebSec Classic T-Shirt', 'Some quick example text to build on the card title and make up the bulk of the cards content.', 1999, '/assets/img/prod/prod_tshirt1.jpg');
